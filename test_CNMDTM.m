...
%
% Output: 
% We output the global optimal solution 
% of the problem, the number of local optimal solutions found by CNMDTM
...
tol = 1e-6;
tic
[sol_mat,success_flag,x_opt,f_opt] = CNMDTM(problem.objective,x0,ub,lb,tol);
CPU_time = toc;

% Output the global minumum value computed by CNMDTM.
fprintf('The global minimum value computed by CNMDTM is %12.8f\n',f_opt);

%Output the computational time of CNMDTM.
fprintf('The computational time of CNMDTM is %8.4f\n',CPU_time);
