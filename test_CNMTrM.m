...
% problem by using continuation Newton methods from multi-start points.
%
...
% 
% x0: it denotes the initial point of CNMTrM.
%
...
% of the problem, the number of local optimal solutions found by CNMTrM
...
% We call the subroutine function CNMTrM.m to get the global optimal 
...
% [x_opt,f_opt,Num_stp, CPUT_time] = CNMTrM(func,x0,tol,ub, lb);
...
tol = 1e-6;
tic
[x_opt,f_opt,successmp_flag] = CNMTrM(problem.objective,x0,tol,ub,lb);
CPU_time = toc;

% Output the global minumum value computed by CNMTrM.
fprintf('The global minimum value computed by CNMTrM is %12.8f\n',f_opt);

%Output the computational time of CNMTrM.
fprintf('The computational time of CNMTrM is %8.4f\n',CPU_time);

fprintf('The successmp_flag of CNMTr is %d\n',successmp_flag);
